...
public class depinstorre {

	public static void main(String[] args) {
		String pin = "7498"; // PinDB - d8531a519b3d4dfebece0259f90b466a23efc57b
								// (SHA-1)
		...
		try {
			...
			SecretKeySpec key1;
			key1 = new SecretKeySpec(Arrays.copyOf(
					MessageDigest.getInstance("SHA-1").digest(
							"t0ps3kr3tk3y".getBytes()), 16), "AES");
			cipher.init(2, key1);
			...
			SecretKeySpec key2 = new SecretKeySpec(
					SecretKeyFactory
							.getInstance("PBKDF2WithHmacSHA1")
							.generateSecret(
									new PBEKeySpec(arrayOfChar2, paramString,
											1000, 128)).getEncoded(), "AES");
